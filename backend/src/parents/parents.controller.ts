...
export class ParentsController {
  ...
  getChildAttendance(
    ...
    return this.parentsService.getChildAttendance(req.user.id, studentId, { startDate, endDate, subjectId });
  }
  ...
  @Put(':id/complete')
  @Roles('SUPER_ADMIN')
  updateComplete(@Req() req: any, @Param('id') id: string, @Body() dto: CreateParentDto) {
  ...
  unlinkStudent(
    ...
    return this.parentsService.unlinkStudent(id, studentId, req.user.id, dto.reason);
  }

  @Post(':id/documents')
  @Roles('SUPER_ADMIN')
  addDocument(@Req() req: any, @Param('id') id: string, @Body() dto: GuardianDocumentDto) {
  ...
  @Roles('SUPER_ADMIN')
  createPortalAccount(@Param('id') id: string, @Body() dto: CreateParentPortalAccountDto) {
  ...
  resetPassword(@Param('id') id: string) {
    return this.parentsService.resetPortalPassword(id);
  }

  @Patch(':id/account-status')
  @Roles('SUPER_ADMIN')
  updateAccountStatus(@Param('id') id: string, @Body() dto: UpdateParentAccountStatusDto) {
