    ...
    <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="fixed inset-0 -z-10 transition-opacity duration-500">
          {theme === 'dark' ? (
            ...
            <>
              {/* Light theme - More subtle orbs for better content visibility */}
              <div className="absolute top-0 left-1/4 h-80 w-80 rounded-full bg-emerald-200/25 blur-3xl animate-pulse" />
              <div className="absolute bottom-0 right-1/4 h-80 w-80 rounded-full bg-cyan-200/25 blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
              <div className="absolute top-1/2 left-1/2 h-80 w-80 rounded-full bg-violet-200/25 blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
            </>
          )}
        </div>
